...
#define VectorSum XMVectorSum
    ...
    {
        XMVECTOR m_pvTemp = XMVectorSwizzle<2, 3, 0, 1>(V);
        XMVECTOR vTemp2 = XMVectorAdd(V, m_pvTemp);
        m_pvTemp = XMVectorSwizzle<1, 0, 3, 2>(vTemp2);
        return XMVectorAdd(m_pvTemp, vTemp2);
    }
#endif
