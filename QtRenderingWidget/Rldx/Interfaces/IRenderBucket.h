...
namespace Rldx {
	...
	class DxRenderItemMesh : public IRenderQueueItem
	{
		...
		DxDeformerDataBuffer* derformerBuffer = nullptr; // TODO: obtaine during scene graph parsing, from the "DxMeshNode::pDerformerNode" field
