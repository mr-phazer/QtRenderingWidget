...
bool CDXUTIMEEditBox::StaticMsgProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_IME_SETCONTEXT:
        ...
        //
        // We don't want anything to display, so we have to clearPixels this
        //
        lParam = 0;
        return false;
    ...
    case WM_IME_STARTCOMPOSITION:
        ...
        // Since the composition string has its own caret, we don't renderQuad
...
void CDXUTIMEEditBox::RenderCandidateReadingWindow(bool bReading)
{
    ...
    if (!bHasPosition)
    {
        ...
        // Fall back to renderQuad at 0, 0.  Some part of the window
        // will be cut off.
        rc.left = 0;
...
void CDXUTIMEEditBox::Render(_In_ float fElapsedTime)
{
    ...
    // Let the parent renderQuad first (edit control)
    ...
    //
    // Now renderQuad the IME elements
    //
